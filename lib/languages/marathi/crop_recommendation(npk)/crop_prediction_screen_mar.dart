...
class CropPredictionScreenMR extends StatefulWidget {
  const CropPredictionScreenMR({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenMR> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenMR> {
