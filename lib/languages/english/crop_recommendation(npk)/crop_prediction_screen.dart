...
class _CropPredictionScreenState extends State<CropPredictionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Colors.green[100], // Whole page background
      body:
          _isInitialized
              ? Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      ...
                      child: Text(
                        "Provide the values and We'll recommend the crops",
                    ...
                    // Centered Scrollable Square Cards
                    Expanded(
                      child: Center(
                        child: SizedBox(
                          height: 220,
                    ...
                    // Predict Button (default Flutter background)
                    Padding(
