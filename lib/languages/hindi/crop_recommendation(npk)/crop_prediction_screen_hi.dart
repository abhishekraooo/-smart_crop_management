...
import 'crop_result_screen_hi.dart';

class CropPredictionScreenHI extends StatefulWidget {
  const CropPredictionScreenHI({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenHI> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenHI> {
  final TfliteService _tflite = TfliteService();
  late Map<String, FeatureRange> featureRanges;
  final LanguageStrings _strings = HindiStrings();
