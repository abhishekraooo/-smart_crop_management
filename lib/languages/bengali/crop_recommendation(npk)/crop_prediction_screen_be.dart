...
class CropPredictionScreenBE extends StatefulWidget {
  const CropPredictionScreenBE({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenBE> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenBE> {
  final TfliteService _tflite = TfliteService();
  late Map<String, FeatureRange> featureRanges;
  final LanguageStrings _strings = BengaliStrings();
