...
class CropPredictionScreenTE extends StatefulWidget {
  const CropPredictionScreenTE({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenTE> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenTE> {
  final TfliteService _tflite = TfliteService();
  late Map<String, FeatureRange> featureRanges;
  final LanguageStrings _strings = TeluguStrings();
