...
class CropPredictionScreenMA extends StatefulWidget {
  const CropPredictionScreenMA({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenMA> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenMA> {
  final TfliteService _tflite = TfliteService();
  late Map<String, FeatureRange> featureRanges;
  final LanguageStrings _strings = MalayalamStrings();
