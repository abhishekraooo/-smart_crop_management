...
class CropPredictionScreenTA extends StatefulWidget {
  const CropPredictionScreenTA({Key? key}) : super(key: key);

  @override
  State<CropPredictionScreenTA> createState() => _CropPredictionScreenHIState();
}

class _CropPredictionScreenHIState extends State<CropPredictionScreenTA> {
  final TfliteService _tflite = TfliteService();
  late Map<String, FeatureRange> featureRanges;
  final LanguageStrings _strings = TamilStrings();
